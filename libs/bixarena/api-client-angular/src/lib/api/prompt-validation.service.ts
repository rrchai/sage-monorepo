...
// @ts-ignore
import { PromptValidation } from '../model/prompt-validation';
...
export class PromptValidationService {
  ...
  ): Observable<HttpResponse<PromptValidation>>;
  public validatePrompt(
    prompt: string,
    observe?: 'events',
    reportProgress?: boolean,
  ...
  ): Observable<HttpEvent<PromptValidation>>;
  public validatePrompt(
    prompt: string,
    observe: any = 'body',
    ...
    if (prompt === null || prompt === undefined) {
      throw new Error(
        'Required parameter prompt was null or undefined when calling validatePrompt.',
      );
    }
    ...
    let localVarPath = `/validate-prompt`;
    return this.httpClient.request<PromptValidation>(
      'get',
